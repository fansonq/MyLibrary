 ...
 *         Created Time: 2017/12/1 10:42
 *         Describe：Rxbus2的主要处理
 */

public class MyRxbus2 {

    protected static MyRxbus2 mInstance;
    ...
    public static MyRxbus2 getInstance() {
        if (mInstance == null) {
            synchronized (MyRxbus2.class) {
                if (mInstance == null) {
                    mInstance = new MyRxbus2();
                }
            }
        }
        return mInstance;
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(Subscribe.class)) {
                ...
                if (parameterType != null && parameterType.length == 1) {
                    ...
                    int code = sub.eventTag();
                    EventThread threadMode = sub.threadMode();
    ...
    private void addSubscriber(final SubscriberMethod subscriberMethod) {
        ...
        Disposable subscription = EventThread.postToObservable(flowable, subscriberMethod)
