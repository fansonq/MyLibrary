...
/**
 * Created by：fanson
 * Created on：2017/8/24 13:57
 * Describe：
 */

public class PullZoomInListViewEx extends PullZoomInBase<ListView> implements AbsListView.OnScrollListener {
    private static final String TAG = PullZoomInListViewEx.class.getSimpleName();
    ...
    public PullZoomInListViewEx(Context context) {
        this(context, null);
    }

    public PullZoomInListViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * PullZoomInListViewEx.sInterpolator.getInterpolation(f1);
