package com.example.fansonlib.function.download.db;
...
import com.example.fansonlib.function.download.entity.DownloadFlag;
...
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_DATE;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_DOWNLOAD_FLAG;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_DOWNLOAD_SIZE;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_EXTRA1;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_EXTRA2;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_EXTRA3;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_EXTRA4;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_EXTRA5;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_ID;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_IS_CHUNKED;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_MISSION_ID;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_SAVE_NAME;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_SAVE_PATH;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_TOTAL_SIZE;
import static com.example.fansonlib.function.download.db.Db.RecordTable.COLUMN_URL;
import static com.example.fansonlib.function.download.db.Db.RecordTable.TABLE_NAME;
import static com.example.fansonlib.function.download.db.Db.RecordTable.insert;
import static com.example.fansonlib.function.download.db.Db.RecordTable.read;
import static com.example.fansonlib.function.download.db.Db.RecordTable.update;
