...
/**
 * Created by：fanson
 * Created on：2017/10/18 13:35
 * Describe：图文混排编辑器
 */

public class CustomEditor extends ScrollView {
    ...
    public CustomEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        EditText firstEdit = createEditText(context.getString(R.string.please_input), dip2px(context, EDIT_PADDING));
    ...
    public EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout.custom_editor, null);
    ...
    public List<EditData> buildEditData() {
        ...
        for (int index = 0; index < num; index++) {
            ...
            if (itemView instanceof EditText) {
                ...
                ImageEditor item = (ImageEditor) itemView.findViewById(R.id.custom_edit_iv);
