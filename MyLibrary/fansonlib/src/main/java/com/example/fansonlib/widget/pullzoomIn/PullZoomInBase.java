package com.example.fansonlib.widget.pullzoomIn;
...
/**
 * Created by：fanson
 * Created on：2017/8/24 13:53
 * Describe：
 */

public abstract class PullZoomInBase<T extends View> extends LinearLayout implements IPullZoomIn<T>{
    ...
    public PullZoomInBase(Context context) {
        this(context, null);
    }

    public PullZoomInBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //初始化状态View
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PullZoomInView);

            int zoomViewResId = a.getResourceId(R.styleable.PullZoomInView_zoomView, 0);
            if (zoomViewResId > 0) {
                mZoomView = mLayoutInflater.inflate(zoomViewResId, null, false);
            }

            int headerViewResId = a.getResourceId(R.styleable.PullZoomInView_headerView, 0);
            if (headerViewResId > 0) {
                mHeaderView = mLayoutInflater.inflate(headerViewResId, null, false);
            }

            isParallax = a.getBoolean(R.styleable.PullZoomInView_isHeaderParallax, true);
