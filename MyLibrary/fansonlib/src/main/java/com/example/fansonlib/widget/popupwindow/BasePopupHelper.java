...
final class BasePopupHelper {
    ...
    //callback
    private BasePopup.OnDismissListener mOnDismissListener;
    private BasePopup.OnBeforeShowCallback mOnBeforeShowCallback;
    ...
    public BasePopupHelper setExitAnimation(Animation exitAnimation) {
        if (mExitAnimation == exitAnimation) {
            return this;
        }
    ...
    public BasePopup.OnDismissListener getOnDismissListener() {
        return mOnDismissListener;
    }

    public BasePopupHelper setOnDismissListener(BasePopup.OnDismissListener onDismissListener) {
        mOnDismissListener = onDismissListener;
        return this;
    }

    public BasePopup.OnBeforeShowCallback getOnBeforeShowCallback() {
        return mOnBeforeShowCallback;
    }

    public BasePopupHelper setOnBeforeShowCallback(BasePopup.OnBeforeShowCallback onBeforeShowCallback) {
