...
public abstract class BasePopup implements IBasePopup, PopupWindow.OnDismissListener, IPopupController {
    private static final String TAG = BasePopup.class.getSimpleName();
     ...
     * popupwindow是否需要淡入淡出
     */
    public BasePopup setNeedPopupFade(boolean needPopupFadeAnima) {
     ...
     * 设置popup的动画style
     */
    public BasePopup setPopupAnimaStyle(int animaStyleRes) {
     ...
     */
    public BasePopup setAdjustInputMethod(boolean needAdjust) {
     ...
     * @return
     */
    public BasePopup setAdjustInputMethod(boolean needAdjust, int flag) {
        if (needAdjust) {
     ...
     */
    public BasePopup setAutoShowInputMethod(boolean autoShow) {
     ...
     * 在android M之后失效
     */
    public BasePopup setBackPressEnable(final boolean backPressEnable) {
     ...
     */
    public BasePopup setPopupWindowFullScreen(boolean needFullScreen) {
    ...
    public BasePopup setOnBeforeShowCallback(OnBeforeShowCallback mOnBeforeShowCallback) {
        mHelper.setOnBeforeShowCallback(mOnBeforeShowCallback);
        return this;
    }

    public BasePopup setShowAnimation(Animation showAnimation) {
    ...
    public BasePopup setShowAnimator(Animator showAnimator) {
    ...
    public BasePopup setExitAnimation(Animation exitAnimation) {
    ...
    public BasePopup setExitAnimator(Animator exitAnimator) {
     ...
     * @param popupGravity
     */
    public BasePopup setPopupGravity(int popupGravity) {
    ...
    public BasePopup setAutoLocatePopup(boolean autoLocatePopup) {
     ...
     */
    public BasePopup setDismissWhenTouchOutside(boolean dismissWhenTouchOutside) {
        mHelper.setDismissWhenTouchOutside(dismissWhenTouchOutside);
        return this;
    }

    public BasePopup setOutsideTouchable(boolean touchable) {
    ...
    private Animation.AnimationListener mAnimationListener = new SimpleAnimUtil.AnimationListenerAdapter() {
        @Override
    ...
    protected Animation getDefaultScaleAnimation(boolean in) {
        return SimpleAnimUtil.getDefaultScaleAnimation(in);
    }
    ...
    protected Animation getDefaultAlphaAnimation(boolean in) {
        return SimpleAnimUtil.getDefaultAlphaAnimation(in);
    }
