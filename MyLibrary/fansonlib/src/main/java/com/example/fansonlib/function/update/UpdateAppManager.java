...
public class UpdateAppManager {
    ...
    public void showDialog() {
        ...
        if (mContext != null ) {
            Intent updateIntent = new Intent(mContext, DialogActivity.class);
    ...
    public void checkNewApp(final UpdateCallback callback) {
        ...
        if (DialogActivity.isShow ) {
            callback.onAfter();
            Toast.makeText(mContext, "app正在更新", Toast.LENGTH_SHORT).show();
            return;
        }
        //拼接参数
    ...
    public static class Builder {
        ...
        public UpdateAppManager build() {
            //校验
            if (getContext() == null || getHttpManager() == null || TextUtils.isEmpty(getUpdateUrl())) {
            ...
            if (TextUtils.isEmpty(getAppKey())) {
                String appKey = Utils.getManifestString(getContext(), UPDATE_APP_KEY);
