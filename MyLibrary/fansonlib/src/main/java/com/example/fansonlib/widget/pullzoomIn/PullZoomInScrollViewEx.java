...
/**
 * Created by：fanson
 * Created on：2017/8/24 13:59
 * Describe：
 */

public class PullZoomInScrollViewEx extends PullZoomInBase<ScrollView> {
    private static final String TAG = PullZoomInScrollViewEx.class.getSimpleName();
    ...
    public PullZoomInScrollViewEx(Context context) {
        this(context, null);
    }

    public PullZoomInScrollViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void handleStyledAttributes(TypedArray a) {
        ...
        int contentViewResId = a.getResourceId(R.styleable.PullZoomInView_contentView, 0);
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * PullZoomInScrollViewEx.sInterpolator.getInterpolation(f1);
